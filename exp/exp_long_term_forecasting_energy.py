...
class Exp_Long_Term_Forecast_energy(Exp_Basic):
    def __init__(self, args):
        super(Exp_Long_Term_Forecast_energy, self).__init__(args)
    ...
    def test(self, setting, dataset, test=0):
        ...
        txt = "result_long_term_forecast" + "_" + dataset + ".txt"
        f = open(txt, 'a')
        #f = open("result_long_term_forecast_score.txt", 'a')
        f.write(setting + "  \n")
